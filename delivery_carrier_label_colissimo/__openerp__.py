...
Intrastat
~~~~~~~~~~~~
CN23 report requires 'Code SH' field (aka N° tarifaire) in product categories
Every categories should have this field defined.

See l10n_fr_intrastat_product module documentation
