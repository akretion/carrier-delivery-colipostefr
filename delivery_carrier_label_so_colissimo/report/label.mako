...
^FO450,130^FDRef Client: ${d['custom_shipping_ref']}^FS
...
^FO25,175^A0,30,30^FD${c['name']}^FS
...
^FB400,6,3,
^FDCOMPTE CLIENT: ${c['account']}
\&SITE DE PRISE EN CHARGE:
\&${c['center_support_city']} PFC
...
% if product_code == '6J':
^FO670,370^BY3,,80^BCR,100,N,N,N^FD>:${account_chargeur[0:1] + '>5'}${account_chargeur[1:]}^FS
^FO650,460^A0B,18^FD${account_chargeur}^FS
% endif
% endif
...
% if product_code in ['6C','6A', '6K']:
^FO5,660^GB465,200,4^FS
^FO30,675^A0,24,28
^FD${d['address']['name']}^FS
^FO30,705^FB400,6,2,
^FD${d['address']['street']}
\&${d['address']['street2'] or ''}^FS
^FO30,780^A0,40^FD${d['address']['zip']} ${d['address']['city']}^FS
%else:
^FO5,660^GB465,200,4^FS
...
^FB400,6,2
% if product_code in ['6C','6A', '6K']:
^FDCode porte : ${d['address']['door_code']}
\&Code porte2 : ${d['address']['door_code2']}
\&Interphone : ${d['address']['intercom']}
\&Téléphone Portable: ${d['address']['mobile']}
\&Téléphone : ${d['address']['phone']}^FS
% elif product_code in ['6H', '6M', '6J']:
^FDAdresse 1: ${d['address']['street']}
\&Adresse 2: ${d['address']['street2']}
\&Adresse 3: ${d['address']['street3']}
\&Adresse 4: ${d['address']['street4']}
\&${d['address']['zip']} ${d['address']['city']}
\&Téléphone : ${d['address']['mobile']}^FS
% endif
